...
public class PaceProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI("com.kct.sports.provider.sportsPaceDate", "pace", 1);
        sUriMatcher.addURI("com.kct.sports.provider.sportsPaceDate", "pace/#", 2);
        mTraceProjectionMap.put("_id", "_id");
        mTraceProjectionMap.put("item_id", "item_id");
        mTraceProjectionMap.put("get_time", "get_time");
        mTraceProjectionMap.put("space", "space");
    }
