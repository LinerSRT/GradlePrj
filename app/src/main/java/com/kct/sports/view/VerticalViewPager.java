...
public class VerticalViewPager extends ViewGroup {
    ...
    private int showIndicatorCount = 0;
    ...
    private class PagerObserver extends DataSetObserver {
        /* synthetic */ PagerObserver(VerticalViewPager this$0, PagerObserver pagerObserver) {
            this();
        }
    ...
    public VerticalViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.VerticalViewPager, 0, 0);
        this.showIndicator = a.getBoolean(R.styleable.VerticalViewPager_showIndicator2, true);
        this.showIndicatorCount = a.getInteger(R.styleable.VerticalViewPager_showCountIndicator2, -1);
        this.indicatorHighColor = a.getColor(R.styleable.VerticalViewPager_indicatorHighColor2, this.indicatorHighColor);
        this.indicatorNormalColor = a.getColor(R.styleable.VerticalViewPager_indicatorNormalColor2, this.indicatorNormalColor);
        this.indicatorPadding = a.getDimensionPixelOffset(R.styleable.VerticalViewPager_indicatorPadding2, this.indicatorPadding);
        this.indicatorRadius = a.getDimensionPixelOffset(R.styleable.VerticalViewPager_indicatorRadius2, this.indicatorRadius);
        this.indicatorMargin = a.getDimensionPixelOffset(R.styleable.VerticalViewPager_indicatorMargin2, this.indicatorMargin);
        a.recycle();
    }
            ...
            if (hasFocus()) {
                ...
                if (itemInfo == null || itemInfo.position != this.mCurItem) {
                    for (int i2 = 0; i2 < getChildCount(); i2++) {
                        ...
                        ItemInfo ii5 = infoForChild(child2);
                        if (ii5 != null && ii5.position == this.mCurItem && child2.requestFocus(focusDirection)) {
                            break;
                        }
                    }
                }
    ...
    private void enableLayers(boolean enable) {
        int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
            ViewCompat.setLayerType(getChildAt(i), enable ? ViewCompat.LAYER_TYPE_HARDWARE : ViewCompat.LAYER_TYPE_NONE, null);
        }
    }
            ...
            case 2:
                ...
                if (activePointerId != -1) {
                    ...
                    if (!(dy == 0.0f || isGutterDrag(this.mLastMotionY, dy))) {
                        if (canScroll(this, false, (int) dy, (int) x2, (int) y)) {
